#ifndef _HELLO_WORLD_2_APP_H_
#define _HELLO_WORLD_2_APP_H_
...
//  The [HelloWorld2]App class must inherit from the UiApp class,
//  which provides the basic features necessary to define a UI application.
 
class HelloWorld2App
